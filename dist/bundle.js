...
function buildOneDream(dream) {
  ...
  dreamElement.innerHTML = "<div class=\"card text-center\" id=\"".concat(dream.id, "\">\n      <h4 class=\"card-header font-weight-bold\">").concat(dream.description, "</h4>\n      <img class=\"card-img-top\" src=\"").concat(dream.imagePath, "\" alt=\"\">\n      <div class=\"card-body\">\n          <a href=\"#\" class=\"button-action btn btn-").concat(dream.done ? "secondary" : "danger", " btn-block font-weight-bold\">").concat(dream.done ? "Je l'ai fait mais, je veux le refaire !!" : "Et puis zut, je prends un avion !!", "</a>\n      </div>\n      <div class=\"card-footer text-right\">\n          \n          <a href=\"#\" class=\"button-visit btn btn-outline-secondary btn-sm\">Visiter</a>\n          <a href=\"").concat(dream.link, "\" target=\"_blank\" class=\"button-info btn btn-outline-dark btn-sm\">Plus d'infos</a>\n      </div>\n    </div>");
...
function visitDream(dreamId) {
  var position = _data__WEBPACK_IMPORTED_MODULE_0__.data.filter(function (item) {
...
function toggleDreamDone(dreamId) {
  var dream = _data__WEBPACK_IMPORTED_MODULE_0__.data.filter(function (item) {
    return item.id == dreamId;
  })[0];
